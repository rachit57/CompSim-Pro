const workforce = [
  ...
  { id: 'E2', name: 'Priya Iyer', name_safe: 'Priya I.', level: 'M1', role: 'Director Product', city: 'Bangalore', tier: 1, currentPay: 6200000, marketMid: 6000000, performance: 4, dept: 'Product', gender: 'F', type: 'executive', sto: 0.25, lti: 0.3, managerId: 'E1', connections: ['E1', 'S1', 'N1'] },
  ...
  { id: 'S3', name: 'Vikram Rao', level: 'P2', role: 'Sales Executive', city: 'Hyderabad', tier: 2, currentPay: 1200000, marketMid: 1300000, performance: 3, dept: 'Sales', gender: 'M', type: 'sales', commissionRate: 0.05, accelerator: 1.2, achievement: 1.05, managerId: 'S1', connections: ['S1', 'N2'] },
  ...
  { id: 'N1', name: 'Rohan Verma', level: 'P5', role: 'Sr. Backend Engineer', city: 'Bangalore', tier: 1, currentPay: 4200000, marketMid: 4500000, performance: 5, dept: 'Tech', gender: 'M', type: 'normal', managerId: 'E2', connections: ['E2', 'N2', 'N5'] },
  ...
  { id: 'N5', name: 'Sneha Kulkarni', level: 'P2', role: 'QA Engineer', city: 'Mysore', tier: 4, currentPay: 800000, marketMid: 950000, performance: 2, dept: 'Tech', gender: 'F', type: 'normal', managerId: 'N1', connections: ['N1'] },
  { id: 'N6', name: 'Raj Kumar', level: 'P2', role: 'Logistics Lead', city: 'Jaipur', tier: 3, currentPay: 1100000, marketMid: 1050000, performance: 4, dept: 'Operations', gender: 'M', type: 'normal', managerId: 'E3', connections: ['E3', 'N3', 'S4', 'N7'] },
  ...
  { id: 'N8', name: 'Zoya Khan', level: 'P1', role: 'Junior HR', city: 'Indore', tier: 3, currentPay: 500000, marketMid: 520000, performance: 5, dept: 'HR', gender: 'F', type: 'normal', managerId: 'E1', connections: ['N7'] }
];
